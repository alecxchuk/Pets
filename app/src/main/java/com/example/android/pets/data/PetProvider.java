...
public class PetProvider extends ContentProvider {
    ...
    static {
        ...
        // set the integer value for the whole pets table in pets database to 100
        sUriMatcher.addURI(PetContract.CONTENT_AUTHORITY, PetContract.PATH_PETS, PETS);
        //set the integer value for a single row in pets table to 101.
        //Note the wild card character is used to denote a length integer which refers to the id
        //for the specific row we are interested in.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case PETS:
                ...
                // This will perform a query on the pets table to return a
                // Cursor containing the whole table.
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        // there are no values).
        // The third argument is the ContentValues object containing the info for the new pet.
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            default:
                throw new IllegalStateException("Unknown URI " + uri + " with mathch " + match);
        }
    }
}
