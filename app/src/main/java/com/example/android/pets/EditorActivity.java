...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentPetUri == null) {
            ...
            setTitle(R.string.editor_add_pet_title);
            ...
            setTitle(R.string.editor_edit_pet_title);
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null) {
            ...
            int rowsAffected = getContentResolver().update(PetContract.PetEntry.CONTENT_URI, values,
                    null, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_delete:
                // Do nothing for now
                DialogInterface.OnClickListener deleteButtonClickListener = new
            ...
            case android.R.id.home:
                // if the pet hasn't changed, continue with navigating to the parent activity
                ...
                // Create listener to handle the user confirming that
    ...
    public void onBackPressed() {
        // if the pet has'nt changed, continue with handling the back button press
        if (!mPetHasChanged) {
            super.onBackPressed();
            return;
        }
    ...
    public Loader<Cursor> onCreateLoader(int i, @Nullable Bundle bundle) {
        ...
        return new CursorLoader(this, mCurrentPetUri, projection, null,
                null, null);
    }
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            mWeightEditText.setText(Integer.toString(cursor.getInt(weightColumnIndex)));
